...
class AdaIN:
    def __init__(
        self,
        decoder_path="/projectnb/cs598/students/ac25/CS598-VLC/style_transfer_experiments/adain/decoder.pth",
        vgg_path="/projectnb/cs598/students/ac25/CS598-VLC/style_transfer_experiments/adain/vgg_normalised.pth",
    ):
        # Load encoder
        self.vgg = vgg
        self.vgg.eval()
